...
export const LectureList = (props)=>{
    ...
    return <Space direction="vertical" style={{ width: '100%' }} size={[0, 48]}>
        <Layout>
            ...
            <Content>
                <Col style={{backgroundColor: "#E7762F", paddingBottom: 60, marginBottom: 60}}>
                    <Row>
                        <h1 style={{textTransform: "uppercase", fontSize: 28, marginTop: 40, marginBottom: 40, fontWeight:"bold", textAlign: "center", flex: 1}}>
                            Featured Lectures
                        </h1>
                    </Row>
                    <Row style={{paddingLeft: 200, paddingRight:  40}}>
                        <Space size={40} style={{overflow: "scroll"}}>
                            {
                                avatar.map(i => {
                                    return <Image onClick={()=>onPress(true)} style={{height:300, width:200}} src={i} preview={false}/>
                ...
                <Row style={{width: "90%", justifyContent: "center", backgroundColor: "#ccc", marginLeft: "5%", paddingTop: 100, paddingBottom: 100}}>
                    <div style={{width: "80%", alignSelf: "center", marginBottom:  40}}>
                        <Col style={{marginBottom: 120}}>
                            <div style={{fontSize: 24, fontWeight: 'bold', marginBottom: 24}}>Field</div>
                            <Space size={40} style={{overflow: "scroll"}}>
                                {
                                    avatar.map(i => {
                                        return <Image style={{height:300, width:200, borderRadius: 12}} src={i} preview={false}/>
                                    })
                                }
                            </Space>
                        </Col>
