  ...
  return (
    <>
        <div className="w-[340px] flex flex-col">
          <h1 className="text-center text-[22px]">Log In</h1>
          <h1 className="text-[12px] mt-4">Email address</h1>
          <input className="rounded-lg border-2 border-[#555FD9] bg-white h-10 px-3 focus:outline-none hover:bg-[#f0f0f0]"
            type="text"
          ...
          <input className="rounded-lg border-2 border-[#555FD9] bg-white h-10 px-3 focus:outline-none hover:bg-[#f0f0f0]"
            ...
            required
          />
          <a href="/login/recovery" className="text-[12px] text-right pt-3">Forgot password</a>
          <button className="flex w-[340px] h-[36px] my-[19px] justify-center items-center text-white font-bold rounded-md bg-[#555FD9] hover:bg-[#1e2bb7] active:bg-[#040c6e]"
            onClick={()=>handleLogin()}
          >
            Log in
          </button>
